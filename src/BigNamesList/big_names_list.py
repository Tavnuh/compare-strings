def big_names_list():
    big_names_list = ['Aaliyah', 'Abagail', 'Abbey', 'Abbie', 'Abbigail', 'Abby', 'Abigail',
        ...
        'Zoa', 'Zoe', 'Zoey', 'Zoie', 'Zola', 'Zona', 'Zora', 'Zula','Aaden', 'Aarav', 'Aaron', 'Ab', 'Abb', 'Abbott', 'Abdiel', 'Abdul',
        ...
        'Zeke', 'Zenas', 'Zeno', 'Zigmund', 'Zion', 'Zollie','Abbott', 'Abernathy', 'Abshire', 'Adams', 'Altenwerth', 'Anderson',
